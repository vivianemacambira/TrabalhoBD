...
public class CadastroPCD extends javax.swing.JFrame {
    ...
    private void botaoInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoInserirActionPerformed
        int opcao = JOptionPane.showConfirmDialog(this, "Deseja realmente inserir esta pessoa?", "Cadastro", JOptionPane.YES_NO_CANCEL_OPTION);
        if (opcao == JOptionPane.YES_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Pessoa inserida com sucesso", "Cadastro", JOptionPane.INFORMATION_MESSAGE);
